  ...
  return (
    <main>
      <div className="bg-white shadow-md text-black">
        <h2 className="text-3xl text-center font-extrabold mt-8 pt-8">Profile</h2>
        <div className="h-70 w-200 pt-8 px-8">
          <h1 className="text-3xl text-left font-semibold mt-2">Ume Yukito</h1>
          <h2 className="text-xl text-left mt-2">Aizu University</h2>
